...
print("Loading your AI personal assistant Vaani")
speak("Loading your AI personal assistant Vaani")
wishMe()
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "good bye" in statement or "ok bye" in statement or "stop" in statement or "bye bye" in statement or "bye" in statement:
            speak('your personal assistant Vaani is shutting down,Good bye')
            print('your personal assistant Vaani is shutting down,Good bye.')
            break
            ...
            print('''I am your sweet and intelligent Assistant Vaani version 1.0 . I am programmed to minor tasks like
                  opening youtube,google chrome, gmail and stackoverflow ,predict time,take a photo,search wikipedia,predict weather
                  In different cities, get top headline news from times of india and you can ask me computational or geographical questions too!''')
            speak('''I am your sweet and intelligent Assistant Vaani version 1 point 0.  I am programmed to minor tasks like
                  opening youtube,google chrome, gmail and stackoverflow ,predict time,take a photo,search wikipedia,predict weather
                  In different cities, get top headline news from times of india and you can ask me computational or geographical questions too!''')
        elif "who created you" in statement or "who discovered you" in statement:
            print("I was built by Tanya")
            speak("I was built by Tanya")
